...
const mockGetSearchHeroesAction = vi.mocked(getSearchHeroesAction);
...
describe('SearchPage', () => {
  ...
  test('should render SearchPage with default values', () => {
    ...
    expect(mockGetSearchHeroesAction).toHaveBeenCalledWith({
      name: undefined,
      strength: undefined,
    });
  ...
  test('should render HeroGrid with search results', async () => {
    ...
    mockGetSearchHeroesAction.mockResolvedValue(mockHeroes);
    renderSearchPage();
