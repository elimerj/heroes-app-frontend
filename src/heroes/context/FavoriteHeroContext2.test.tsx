...
//Sobre escribimos el localstorage con el mock
...
describe('FavoriteHeroContext', () => {
  ...
  test('should add hero to favorite when toggle favorite is called with a new hero', () => {
    renderContextTest();
  ...
  test('should remove hero to favorite when toggle favorite is called with a hero', () => {
